...
if __name__ == "__main__":
    ...
    #test_model_num = 150 #the number of the model to test (only if train=False)
    run_name = '2025-05-29-21-18-59_run'
    ...
    def complete2(b):
        ...
        if b[0]['task_type'] == 0 and b[1]['code_employee'] == 0 or b[0]['task_type'] == 1 and b[1]['code_employee'] == 1:
    ...
    agency.add_event([busy2], [employee2, waiting1, completed], complete2, name='done2')
