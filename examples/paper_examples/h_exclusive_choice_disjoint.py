...
if __name__ == "__main__":
    ...
    run_name = "2025-05-29-17-18-42_run" #substitute with the name of the run you want to test
    ...
    agency.add_event([busy1], [employee1], complete1, name='done1', reward_function=lambda x: 1)
